...
class _LoginPageState extends State<LoginPage>
  ...
  void sendMessagesToEnteredNumber() async {
    ...
    String messageBody =
        'Your scissors salon appointment is scheduled for ${widget.selectedDate.toString()} at ${widget.selectedTimeSlots.join(", ")}. Name: ${_nameController.text}, Phone: ${_phoneController.text}';
  ...
  void sendSMS(String messageBody, String phoneNumber) async {
    ...
    final authToken = '2a51cc575335861d62065ad93ab47a67';
